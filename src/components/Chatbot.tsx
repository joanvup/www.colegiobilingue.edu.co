          ...
          {!isOpen && (
            ...
            >
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="font-bold text-[#1B3A6B] text-[11px] leading-tight">
                        {language === "EN" ? "Institutional Assistant" : "Asistente Institucional"}
                      </p>
                      <p className="text-[11px] text-slate-600 mt-0.5 leading-snug">
                        {language === "EN"
                          ? "Questions about the Handbook or PEI?"
              ...
              <button
                ...
                aria-label={language === "EN" ? "Open institutional chat assistant" : "Abrir asistente institucional"}
                title={language === "EN" ? "Institutional Assistant (Handbook & PEI)" : "Asistente Institucional (Manual y PEI)"}
              >
                {/* Glowing ring */}
                ...
                <span className="max-w-0 overflow-hidden group-hover:max-w-xs group-hover:pl-2.5 transition-all duration-300 font-sans text-xs font-semibold text-white tracking-wide whitespace-nowrap hidden sm:inline-block">
                  {language === "EN" ? "Manual & PEI Assistant" : "Asistente Manual y PEI"}
                </span>
              </button>
            </motion.div>
          )}
            ...
            >
              ...
              <div className="bg-linear-to-r from-[#0F2444] via-[#1B3A6B] to-[#16335f] p-3.5 text-white flex items-center justify-between border-b border-[#C9A961]/30">
                <div className="flex items-center gap-2.5 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-[11px] text-slate-300 truncate">
                      {language === "EN" ? "Manual de Convivencia & PEI" : "Manual de Convivencia y PEI"}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-1 shrink-0 text-slate-300">
                  ...
                  <button
                    ...
                    title={isExpanded ? (language === "EN" ? "Collapse" : "Contraer") : (language === "EN" ? "Expand" : "Expandir")}
                  ...
                  <button
                    ...
                    className="p-1.5 hover:text-white hover:bg-white/10 rounded-lg transition"
                    title={language === "EN" ? "Close assistant" : "Cerrar asistente"}
              ...
              <div className="bg-slate-50 border-b border-slate-200/80 px-3.5 py-1.5 flex items-center justify-between text-[11px] text-slate-600">
                <div className="flex items-center gap-1.5 truncate">
                  ...
                  <span className="truncate">
                    {language === "EN"
                      ? "Exclusive sources: MC_2026-2027_v1.2 & PEI-2026-2027"
                ...
                <span className="text-[10px] font-semibold text-emerald-700 bg-emerald-50 px-1.5 py-0.5 rounded border border-emerald-200 shrink-0">
                  {language === "EN" ? "Grounded" : "Verificado"}
                </span>
              </div>
                    ...
                    >
                      ...
                      {msg.sender === "bot" && (
                        <button
                          ...
                          title={language === "EN" ? "Copy answer" : "Copiar respuesta"}
                  ...
                  >
                    <div className="bg-white border border-slate-200 rounded-2xl rounded-bl-xs px-4 py-3 shadow-xs flex items-center gap-2.5">
                      ...
                      <span className="text-xs text-slate-500 font-medium italic">
                        {language === "EN"
                          ? "Consulting Handbook & PEI documents..."
              ...
              <div className="bg-white border-t border-slate-100 px-3 py-2">
                <div className="flex items-center gap-1.5 mb-1.5 text-[11px] font-semibold text-slate-500">
                  ...
                  <span>{language === "EN" ? "Frequent Inquiries:" : "Consultas frecuentes:"}</span>
                </div>
                ...
                >
                  <div className="relative flex-1">
                    <textarea
                      ...
                      placeholder={
                        language === "EN"
                          ? "Ask about the Handbook or PEI (e.g., enrollment, uniform)..."
                          : "Pregunta sobre el Manual o PEI (ej. matrícula, uniforme)..."
                      }
                      rows={1}
                      disabled={isLoading}
                  ...
                  <button
                    ...
                    title={language === "EN" ? "Send message" : "Enviar consulta"}
